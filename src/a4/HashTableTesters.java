...
public class HashTableTesters {
	...
	public static void main(String[] args) {
		...
		String csvFile = "C:\\Users\\Toshiba\\Downloads\\Songs.csv";
		...
		System.out.println(songTable.containsKey("Fallen Angel"));
		...
		if (temp == null || !temp.getArtist().equals(changed.getArtist()) || temp.getYear() != changed.getYear())
			errors.append("Failed to replace song 'Fallen Angel'.\n");
